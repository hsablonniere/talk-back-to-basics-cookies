...
[quote, Watson]
What are we doing in bloody {city}?
...
I have to ask the question "would we have the open and standard World Wide Web we use today

[slide=text]
[.blink]`<blink>` : best HTML tag ever!

without banner ads using blinkink text
...
While Firefox & Safari are the one really trying to protect their users' privacy
we're in the middle of an endless race,
an endless technical fight that should also be fought with debates and legislations.
